...
#undef SHIELD_IO_MASK_B
#if (ACTIVE_SHIELD_CHANNEL == CH1)
#define SHIELD_MODER_MASK_A_OUT  ((uint32_t)0x00000100)   /* PB4 */
#define SHIELD_MODER_MASK_A      ((uint32_t)0x00000300)
#define SHIELD_COMP2_MASK        ((uint32_t)0x00000010)
#define SHIELD_IO_MASK_A         ((uint32_t)0x00000010)
#elif (ACTIVE_SHIELD_CHANNEL == CH2)
#define SHIELD_MODER_MASK_A_OUT  ((uint32_t)0x00000400)   /* PB5 */
#define SHIELD_MODER_MASK_A      ((uint32_t)0x00000C00)
#define SHIELD_COMP2_MASK        ((uint32_t)0x00000020)
#define SHIELD_IO_MASK_A         ((uint32_t)0x00000020)
#endif
